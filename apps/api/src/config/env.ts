...
const envSchema = z.object({
  ...
  REDIS_L1_CACHE_MAX_ENTRIES: z.coerce.number().default(5000),
  REDIS_L1_CACHE_MAX_BYTES: z.coerce.number().default(16 * 1024 * 1024),
  OPS_DOMAIN_DRIFT_CACHE_TTL_SECONDS: z.coerce.number().default(300),
